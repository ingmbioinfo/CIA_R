...
SO <- score_all_signatures(SO,
  signatures_input = "../inst/extdata/atlas.gmt",
...
```{r}
SO <- CIA_classify(
  data = SO, signatures_input = "../inst/extdata/atlas.gmt",
...
for (t in c(0.05, 0.1, 0.15)) {
  SO <- CIA_classify(
    data = SO, signatures_input = "../inst/extdata/atlas.gmt", unassigned_label = "Unassigned",
