...
<!-- badges: start -->
  [![R-CMD-check](https://github.com/TODO/TODO/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/TODO/TODO/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
This is a basic example which shows you how to use `CIA` on a demo dataset:
...
You can find the rendered version of the documentation of `CIA` at
the project website created with `pkgdown` TODO TODO
